...
// Temporary casts for HeroUI generic variance issues in this TS version
const Select = UISelect as typeof UISelect;
const SelectItem = UISelectItem as typeof UISelectItem;
        ...
        <Controller
          ...
          render={({ field }) => (
            <Input
              ...
              variant="bordered"
              size="md"
              isInvalid={!!errors.patient_info?.age}
            />
          )}
        />
        <Controller
